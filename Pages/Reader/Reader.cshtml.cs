...
namespace EncomendasProject.Pages.Reader
{
    ...
    public class ReaderModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                return new JsonResult(new { success = false, message = "No status update required." });
            }
            ...
            return new JsonResult(new { success = true, message = message, status = Encomenda.Status.ToString() });
        }
